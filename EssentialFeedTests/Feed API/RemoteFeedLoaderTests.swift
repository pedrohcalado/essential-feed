...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONList() {
        ...
        let item2 = makeItem(id: UUID(), description: "a dascription", location: "a location", imageURL: URL(string: "http://another-url.com")!)
    ...
    func test_load_dosNotDeliverResultAfterSUTInstanceHasBeenDealocated() {
    ...
    private func checkForMemoryLeaks(instance: AnyObject, file: StaticString = #filePath, line: UInt = #line) {
